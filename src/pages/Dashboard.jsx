...
export default function Dashboard({ user }) {
  ...
  const handleAssessmentClick = (type) => {
    if (user?.age && user?.country) {
      navigate('/quick-assessment', { state: { type, age: user.age, country: user.country } });
    } else {
  ...
  const handleModalSubmit = (e) => {
    ...
    setShowModal(false);
    navigate('/quick-assessment', { state: { type: selectedAssessment, age: demoAge, country: demoCountry } });
  };
            ...
            <div className="z-10 relative flex-1 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                {latestTest ? (
                  ...
                  <button
                    onClick={() => navigate('/about-16-personalities')}
                    className="btn-secondary"
                  >
                    What is MBTI?
                  </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 px-4 md:px-0">
          {[
            ...
            // },
            {
              ...
              action: () => latestTest && navigate('/career-guide'),
              locked: !latestTest
            },
            {
              label: 'Test Quota',
