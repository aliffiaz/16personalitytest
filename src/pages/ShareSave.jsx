    ...
    <div className="max-w-2xl mx-auto w-full py-6 sm:py-10 px-4">
      <div className="glass-card border-indigo-100 rounded-[2.5rem] p-8 sm:p-14 text-center shadow-2xl relative mb-8 bg-white/40 backdrop-blur-md">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-slate-900 tracking-tight mb-4 leading-tight">
          Download Your <br className="sm:hidden" /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-600">Full Report</span>
        </h1>
        <p className="text-slate-500 text-base sm:text-lg max-w-md mx-auto leading-relaxed mb-8 sm:mb-10 font-medium">
          Your personalised 8-page PDF — complete personality profile, career paths, and AI-driven action plan.
        </p>

        <ul className="text-left max-w-xs sm:max-w-sm mx-auto space-y-3 sm:space-y-4 mb-10 sm:mb-12">
          {[
