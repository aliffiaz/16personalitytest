    ...
    <div className="max-w-6xl mx-auto px-4 pb-24">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center mb-16 sm:mb-24 px-2 sm:px-0">
        ...
        >
          <div>
            ...
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-display font-bold text-slate-900 leading-tight mb-4 sm:mb-6">
               Discovering <br className="hidden sm:block" />
               <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-violet-600">The {type.nickname.replace('The ', '')}</span>
            </h1>
      ...
      <section className="space-y-24 mb-24">
         <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="glass-card p-1 items-center justify-center bg-slate-900 shadow-2xl shadow-indigo-500/10 overflow-hidden relative group">
               <div className="absolute inset-0 bg-gradient-to-tr from-indigo-500/20 to-violet-500/20 opacity-0 group-hover:opacity-100 transition-opacity" />
      ...
      <section className="max-w-4xl mx-auto px-4 mb-24">
         <div className="text-center space-y-8">
            <div className="w-16 h-16 bg-violet-50 text-violet-600 rounded-2xl flex items-center justify-center mx-auto border border-violet-100 shadow-sm">
               <TrendingUp size={32} />
            </div>
