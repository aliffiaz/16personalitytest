...
export default function CareerGuide() {
  ...
  const passedResultId = searchParams.get('resultId');
  ...
  if (error || !careerData) {
    return (
      <div className="flex flex-col items-center justify-center pt-20 space-y-4">
        ...
        <button className="bg-app-primary text-white font-bold py-2 px-6 rounded-xl" onClick={() => router.push('/result')}>Back to Result</button>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto w-full py-6 sm:py-10 px-4 sm:px-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-10">
        ...
        <button
          onClick={() => router.push(`/share-save?resultId=${passedResultId}&mbtiType=${careerData?.mbtiType}`)}
