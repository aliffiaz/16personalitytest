    ...
    >
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        {quota && (
          <motion.div
            ...
            className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest border ${quota.testsRemaining > 0
      ...
      <div className="space-y-4 sm:space-y-6">
        <h1 className="heading-hero px-2">
          Uncover the <span className="brand-shimmer">Essence</span> of Your Mind
        </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 w-full max-w-3xl text-left">
        {[
          ...
          { icon: <Target size={24} />, label: 'Energy', sub: 'Intuition vs Sensing', code: 'N / S', codeFull: 'Intuition vs Sensing', color: 'text-amber-600', bg: 'bg-amber-50' },
