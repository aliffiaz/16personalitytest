...
export default function ShareSave() {
  ...
  const passedMbtiType = searchParams.get('mbtiType');
  ...
  return (
    <div className="max-w-2xl mx-auto w-full py-6 sm:py-10 px-4">
      ...
      <div className="mt-8 flex justify-center">
        <button onClick={() => router.push('/dashboard')} className="text-slate-400 font-bold hover:text-indigo-600 transition-colors text-sm">
          Return to Dashboard
        </button>
      </div>
    </div>
